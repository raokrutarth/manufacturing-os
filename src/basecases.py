...
def bootstrap_demo_mid_2():
    ...
    demo_nodes = [
        SingleItemNode(node_id=i, dependency=ItemDependency([], "")) for i in range(18)
    ]
    ...
    demo_nodes[0].dependency = ItemDependency([], start)
    demo_nodes[1].dependency = ItemDependency([start], screws)
    demo_nodes[2].dependency = ItemDependency([start], screws)
    demo_nodes[3].dependency = ItemDependency([start], wood)
    demo_nodes[4].dependency = ItemDependency([start], wood)
    demo_nodes[5].dependency = ItemDependency([start], glass)
    demo_nodes[6].dependency = ItemDependency([start], glass)
    demo_nodes[7].dependency = ItemDependency([screws, wood], window_frame)
    demo_nodes[8].dependency = ItemDependency([screws, wood], window_frame)
    demo_nodes[9].dependency = ItemDependency([wood, screws], door_knob)
    demo_nodes[10].dependency = ItemDependency([wood, screws], door_knob)
    demo_nodes[11].dependency = ItemDependency([window_frame, glass], window)
    demo_nodes[12].dependency = ItemDependency([window_frame, glass], window)
    demo_nodes[13].dependency = ItemDependency([screws, wood], casing)
    demo_nodes[14].dependency = ItemDependency([screws, wood], casing)
    demo_nodes[15].dependency = ItemDependency([door_knob, window_frame], raw_door)
    demo_nodes[16].dependency = ItemDependency([door_knob, window_frame], raw_door)
    demo_nodes[17].dependency = ItemDependency([casing, raw_door], finished_door)
...
def bootstrap_demo():
    ...
    demo_nodes = [
        SingleItemNode(node_id=i, dependency=ItemDependency([], "")) for i in range(24)
    ]
    ...
    demo_nodes[11].dependency = ItemDependency([metal, screws], door_knob)
    demo_nodes[12].dependency = ItemDependency([metal, screws], door_knob)
    demo_nodes[13].dependency = ItemDependency([screws, wood], door_frame)
    demo_nodes[14].dependency = ItemDependency([screws, wood], door_frame)
    demo_nodes[15].dependency = ItemDependency([window_frame, glass], window)
    demo_nodes[16].dependency = ItemDependency([window_frame, glass], window)
    demo_nodes[17].dependency = ItemDependency([metal], hinge)
    demo_nodes[18].dependency = ItemDependency([metal], hinge)
    demo_nodes[19].dependency = ItemDependency([screws, wood], casing)
    demo_nodes[20].dependency = ItemDependency([screws, wood], casing)
    demo_nodes[21].dependency = ItemDependency([door_knob, door_frame, window_frame], raw_door)
